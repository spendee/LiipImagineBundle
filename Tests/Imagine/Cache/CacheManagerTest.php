...
class CacheManagerTest extends AbstractTest
{
    ...
    public function testShouldDispatchCachePreResolveEvent()
    {
        ...
        $dispatcher
            ->expects($this->at(0))
            ->method('dispatch')
            ->with(Events::PRE_RESOLVE, new CacheResolveEvent('cats.jpg', 'thumbnail'));
    ...
    public function testShouldDispatchCachePostResolveEvent()
    {
        ...
        $dispatcher
            ->expects($this->at(1))
            ->method('dispatch')
            ->with(Events::POST_RESOLVE, new CacheResolveEvent('cats.jpg', 'thumbnail'));
    ...
    public function testShouldAllowToPassChangedDataFromPreResolveEventToResolver()
    {
        ...
        $dispatcher
            ->expects($this->at(0))
            ->method('dispatch')
            ->with(Events::PRE_RESOLVE, $this->isInstanceOf(CacheResolveEvent::class))
    ...
    public function testShouldReturnUrlChangedInPostResolveEvent()
    {
        ...
        $dispatcher
            ->expects($this->at(1))
            ->method('dispatch')
            ->with(Events::POST_RESOLVE, $this->isInstanceOf(CacheResolveEvent::class))
            ->will($this->returnCallback(function ($name, $event) {
